...
{\eightrm Pablo Hernández Jiménez {\lowercase{\eightit{et al.}}}}
...
\title{\MakeUppercase{Clasificación de Conseción de Hipotecas}}

% Authors

\authors{Pablo Hernández Jiménez$^1$}

\vskip3mm

% Address

\address{Tratamiento Inteligente de Datos, Escuela Superior de Ingeniería y Tecnología,\break Universidad de La Laguna\break}
